...
O desenvolvimento moderno exige consistência. Para mitigar o clássico problema do _"na minha máquina funciona"_, o projeto adota o **GitHub Codespaces**, um ambiente de desenvolvimento baseado em nuvem que roda dentro de um container Docker seguro e padronizado.
...
_Exibe a versão do runtime ativa no terminal._
...
_Garantem que a engine do Docker e o orquestrador Compose estão operacionais no ambiente._
...
_Garantem que qualquer novo terminal aberto neste ambiente iniciará automaticamente utilizando a versão especificada._
